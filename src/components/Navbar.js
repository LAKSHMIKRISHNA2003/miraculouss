    ...
    return (
        <nav className="navbars navbar navbar-expand-lg bg-body-tertiary sticky-top">
            <div className="container-fluid">
                <Link className='nostyle' to={"/"}><div className="btn navbar-brand d-flex align-items-center ">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav ms-auto">
                        <Link state={{ target: "home" }} className='nostyle' to={"/"}>
                            <div onClick={scrollToTop} className=" nav-link nav-links btn ">Home</div>
                        </Link>
                        <Link state={{ target: "services" }} className='nostyle' to={"/"}>
                            <div onClick={scrollToServices} className="nav-link nav-links btn">Services</div>
                        </Link>
                        <Link state={{ target: "contactus" }} className='nostyle' to={"/"}>
                            <div onClick={scrollToForm} className="nav-link nav-links btn">Contact US</div>
                        </Link>

                        <Link to={"/Appointments"} className='nostyle'>
                            <div className="nav-link nav-links btn ">Book An Appointment</div>
                        </Link>
